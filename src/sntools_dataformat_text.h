...
struct {
  ...
  int SKYSIG, SKYSIG_T, SKYSIG_GAIN, TEXPOSE ;
  int GAIN, PHOTFLAG, PHOTPROB, XPIX, YPIX, DETNUM, IMGNUM ; 
  int dRA, dDEC, AIRMASS; // May 2023
  int SIMEPOCH_DCR_dRA, SIMEPOCH_DCR_dDEC, SIMEPOCH_DCR_dMAG;
