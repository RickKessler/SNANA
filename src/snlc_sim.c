...
void hostgal_to_SNDATA(int IFLAG, int ifilt_obs) {
  ...
  if ( ifilt_obs == 0 ) {
	...
	SNDATA.HOSTGAL_SPECZ_ERR[m]  = SNHOSTGAL_DDLR_SORT[m].ZSPEC_ERR;
      ...
      /*      if (REFAC_HOSTLIB){
	SNDATA.HOSTGAL_LOGSFR_TRUE[m] = SNHOSTGAL_DDLR_SORT[m].LOGSFR_TRUE;
	SNDATA.HOSTGAL_LOGSFR_OBS[m]  = SNHOSTGAL_DDLR_SORT[m].LOGSFR_OBS ;
	SNDATA.HOSTGAL_LOGSFR_ERR[m]  = SNHOSTGAL_DDLR_SORT[m].LOGSFR_ERR ;
	SNDATA.HOSTGAL_LOGsSFR_TRUE[m] = SNHOSTGAL_DDLR_SORT[m].LOGsSFR_TRUE;
	SNDATA.HOSTGAL_LOGsSFR_OBS[m]  = SNHOSTGAL_DDLR_SORT[m].LOGsSFR_OBS ;
	SNDATA.HOSTGAL_LOGsSFR_ERR[m]  = SNHOSTGAL_DDLR_SORT[m].LOGsSFR_ERR ;
	SNDATA.HOSTGAL_COLOR_TRUE[m] = SNHOSTGAL_DDLR_SORT[m].COLOR_TRUE;
	SNDATA.HOSTGAL_COLOR_OBS[m]  = SNHOSTGAL_DDLR_SORT[m].COLOR_OBS ;
	SNDATA.HOSTGAL_COLOR_ERR[m]  = SNHOSTGAL_DDLR_SORT[m].COLOR_ERR ;
	}*/
