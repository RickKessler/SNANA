...
\begin{verbatim}
   &FITINP
     ISCALE_COURSEBIN_PHOTOZ = 1   # multi-dim grid search (default)
        ! or
     NEVAL_MCMC_PHOTOZ       = 300 # MCMC burn-in with 300 evaluations (not ready)
\end{verbatim} 
%
...
The last step  is a 1D {\tt PEAKMJD} searched in 0.5~day bins ($-2$ to $+2$ days).

NOT READY: The second option (MCMC) processes all 5 parameters simultaneously.
