...
To avoid this potentional CPU bottleneck,
1) the covariance is applied among the subset with SNR$>2$, and
2) the {\tt REDCOV} feature is automatically disabled for {\tt LCLIB} (Galactic)
models.
...
\begin{itemize}
  \item {\tt HOSTLIB\_SPECBASIS\_FILE} points to a file with spectral basis
         ...
         where each vertical {\tt SPECBASIS} column is an SED basis.
