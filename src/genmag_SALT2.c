...
void INTEG_zSED_SALT2(int OPT_SPEC, int ifilt_obs, double z, double Tobs,
  ...
  *Finteg = *Finteg_errPar = 0.0 ;
  ...
  for ( ilamobs=0; ilamobs < NLAMFILT; ilamobs++ ) {
    ...
    // Sep 2026 R.Purohit: optional filter wavecor.
    /* if ( wavecor != 0.0) { */
    ...
    /*   if ( lam_temp < lam_array[0] || lam_temp > lam_array[NLAMFILT-1] ) { */
    /*     TRANS = 0.0 ; */
    /*   } */
    /*   else { */
    /*     TRANS = interp_1DFUN(OPT_INTERP_LINEAR, lam_temp, NLAMFILT, */
    /*                          lam_arry, trans_array, fnam); */
    /*   } */
    /* } */
...
<<<<<<< HEAD
    LAMSED     = (LAMOBS+waveshift) / z1 ;  // rest-frame lambda (waveshift Aug 2026)
=======
    LAMSED     = LAMOBS / z1 ;  // rest-frame lambda 
>>>>>>> waveshift arg passed to genmag_SALT2 ... not yet used, just structural changes
...
<<<<<<< HEAD
	INTEG_zSED_SALT2(0,ifilt_row,z,Tobs, 0.0, parList_SN, parList_HOST, // (I)
=======
...
<<<<<<< HEAD
  INTEG_zSED_SALT2(1, JFILT_SPECTROGRAPH, z, Tobs_SED, 0.0,
=======
...
<<<<<<< HEAD
  INTEG_zSED_SALT2(1, ifilt_obs, z, Tobs, 0.0,    // (I)
