...
\begin{Verbatim}[frame=single]
  ...
  # filter-dependent variants:
   RANSYSTPAR_SIGSHIFT_ZP: 0.014                  # same sigma per band
   RANSYSTPAR_SIGSHIFT_ZP(gr,iz):   0.013 0.02    # sig(g&r)=0.013, sig(i&z.02
   RANSYSTPAR_SIGSHIFT_ZP(g,r,i,z): 0.01 .02 .03 .04  # diff sigma per band

   RANSYSTPAR_SIGSHIFT_LAMFILT:          10         # sig=10 A for each band
   RANSYSTPAR_SIGSHIFT_LAMFILT(g,r,i,z): 8 7 10 9   # sigma per band
