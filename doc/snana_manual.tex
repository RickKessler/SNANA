...
{\tt NGENTOT\_LC}.  {\bf\it Beware} of the following:
\vspace{-0.4cm}
\begin{itemize}[noitemsep]
  \item the requested $b$-profile is realized only if the {\tt SIMLIB} 
          coordinates have isotropic distribution.
  \item For highly anisotropic profiles, set {\tt SIMLIB\_NREPEAT} $\gg1$
