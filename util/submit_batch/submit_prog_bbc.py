...
#
# Jan 28 2026:
#    + devel_flag=41 (Apr 2025) was never made default until now 
#          (remove bbc_prep_1version_match_legacy)
...
class BBC(Program):
    ...
    def bbc_prep_1version_match(self):
        ...
        #sys.exit(f"\n xxx bbc_prep_1version_match: all_one = {all_one}  n_inpdir = {n_inpdir}")  # .xyz

        if all_one :
            logging.info(f"  Auto-match success (1 and only 1 version per INPDIR): " \
