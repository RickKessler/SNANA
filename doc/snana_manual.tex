...
\begin{itemize}
  ...
  \item \verb!GENMODEL_MSKOPT+=256!: Enable an experimental wavelength extrapolation that uses
  a cubic Hermite spline to revert to the Hsiao \cite{Hsiao2007} template outside of the \BAYESN
  wavelength range.
