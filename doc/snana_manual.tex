...
TAKE_SPECTRUM:  MJD(59400:59600:20) TEXPOSE_ZPOLY(1200)   # spectrum every 20 days
\end{Verbatim}
%
...
i) a pre-defined calendar window, or ii) a pre-defined calendar sequence;
...
to {\tt SIMGEN\_DUMPALL} via command line arg,
\begin{verbatim}
...
\begin{verbatim}
  &SNLCINP
     VERSION_PHOTOMETRY = 'folder_name'
          or
     VERSION_PHOTOMETRY = 'folder_name1,folder_name2,folder_name3'
         or 
...
different surveys can be analyzed together.
