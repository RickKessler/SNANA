...
%
   \item Use sim-input ``{\tt HOSTLIB\_SMEAR\_SERSIC: 1.0}'' which
     is loosely interpreted as a FWMH (arcsec) for average PSF.
     This parameter has no impact on placement of SN near galaxy,
     but it affects the DLR calculation as with
       \begin{eqnarray}
         \absmear & \equiv & {\tt HOSTLIB\_SMEAR\_SERSIC}/2 \\
